...
**Household Photos** is a WordPress plugin that provides a way to share private photo 
...
[build/household-photos](build/household-photos)

[build/household-photos.zip](build/household-photos.zip)
...
Start by updating the settings and defining a folder to read photos and generate albums from. 
Then add users to the photo album. 
